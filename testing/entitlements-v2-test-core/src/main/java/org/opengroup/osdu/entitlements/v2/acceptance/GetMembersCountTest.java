...
public abstract class GetMembersCountTest extends AcceptanceBaseTest {

    private final Token token = tokenService.getToken();

    public GetMembersCountTest(ConfigurationService configurationService, TokenService tokenService) {
